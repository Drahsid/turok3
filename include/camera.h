...
typedef struct CCamera {
    ...
    /* 0x2AC */ Vp_t m_vp[2];
    /* 0x2CC */ Vp_t m_vpSecondary[2];
    /* 0x2EC */ uint8_t unk_0x2EC[0x22C];
    /* 0x518 */ int32_t m_nCurrentRegionSet;
    ...
    /* 0x53C */ int32_t m_FogStart;
    /* 0x540 */ int32_t m_LastFogStart;
...
typedef struct {
    ...
    /* 0x11E8 */ int32_t m_bOnlyUseMainCameraForSound;
