...
typedef struct {
    /* 0x00000 */ s32 levelStatus; // "m_LevelStatus"
    /* 0x00004 */ s32 isPersistentDataLoaded; // "m_bPersistentDataLoaded"
    /* 0x00008 */ u32 levelIntroFlags; // "m_LevelIntroPlayedFlags"
    ...
    /* 0x00048 */ s32 loadSavePersistentDataSize;   // "m_LoadSavePersistentDataSize"
    /* 0x0004C */ s32 gamePersistentDataSize;       // "m_GamePersistentDataSize"
    ...
    /* 0x00104 */ u8 unk_0x104[0x1C];
    /* 0x00120 */ UNK_TYPE unk_0x120;
    /* 0x00124 */ UNK_TYPE unk_0x124;
    /* 0x00128 */ u8 unk_0x128[0x1CBE0];
    /* 0x1CD08 */ UNK_TYPE unk_0x1CD08;
    /* 0x1CD0C */ u8 unk_0x1CD0C[0x12C];
    /* 0x1CE38 */ s32 levelIndex; // "m_nLevel"
    /* 0x1CE3C */ u8 unk_0x1CE3C[0x44];
    ...
    /* 0x1D0B8 */ u8 unk_0x1D0B8[0x44];
    /* 0x1D0FC */ UNK_TYPE unk_0x1D0FC;
    /* 0x1D100 */ u8 unk_0x1D100[0x40];
    /* 0x1D140 */ UNK_TYPE unk_0x1D140;
    /* 0x1D144 */ u8 unk_0x1D144[0x1C];
    /* 0x1D160 */ UNK_TYPE unk_0x1D160;
    /* 0x1D16C */ u8 unk_0x1D164[0x2A4];
...
extern void CScene__LoadLevel(CScene* thisx, s32 levelIndex, s32 a2);
extern void CScene__ConstructMap(CScene* thisx, CGameSection* section, s32 objectIndex);
