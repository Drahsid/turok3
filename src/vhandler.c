...
INCLUDE_ASM("asm/nonmatchings/vhandler", func_225704);

INCLUDE_ASM("asm/nonmatchings/vhandler", func_2257C4);

INCLUDE_ASM("asm/nonmatchings/vhandler", func_225B14);

INCLUDE_ASM("asm/nonmatchings/vhandler", func_225C80);

INCLUDE_ASM("asm/nonmatchings/vhandler", func_226128);

INCLUDE_ASM("asm/nonmatchings/vhandler", func_2261BC);

INCLUDE_ASM("asm/nonmatchings/vhandler", func_2261F8);
